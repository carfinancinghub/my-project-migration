...
describe('BuyerSearchPreferences', () => {
  ...
  // Snapshot Tests
  it('matches snapshot for free preference form', () => {
    const { container } = render(<BuyerSearchPreferences isPremium={false} />);
    expect(container).toMatchSnapshot();
  });

  it('matches snapshot for premium preference form with AI suggestions', async () => {
    const { container } = render(<BuyerSearchPreferences isPremium={true} />);

...
// Path: C:\CFH\backend\services\blockchain\BlockchainAdapter.test.js
...
// Save Location: This file should be saved to C:\CFH\backend\services\blockchain\BlockchainAdapter.test.js to test the BlockchainAdapter.js utility.
...
describe('BlockchainAdapter', () => {
  ...
  it('sends transaction with estimated gas price', async () => {
  ...
  it('estimates gas price with buffer', async () => {
    ...
    expect(gasPrice).toBe(22000000000); // 20 Gwei + 10% buffer
  });

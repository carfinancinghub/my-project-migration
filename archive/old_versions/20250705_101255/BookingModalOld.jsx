...
interface Props {
  ...
  isOpen: boolean;
  onClose: () => void;
  onConfirm: (updatedHistory: Transport[], newBadge: string | null) => void;
  transportHistory: Transport[];
  isPremium: boolean;
}

// === Component ===
const BookingModal: React.FC<Props> = ({ transport, isOpen, onClose, onConfirm, transportHistory, isPremium }) => {
  // === State Setup ===

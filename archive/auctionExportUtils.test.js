// File: auctionExportUtils.test.js
// Path: C:\CFH\frontend\src\utils\auction\auctionExportUtils.test.js
// Save Location: This file should be saved to C:\CFH\frontend\src\utils\auction\auctionExportUtils.test.js to test the auctionExportUtils.js utility.
// Purpose: Unit tests for auctionExportUtils.js, covering PDF, CSV, JSON exports, validation, and premium features
...
describe('auctionExportUtils', () => {
  ...
  it('handles undefined data fields gracefully', () => {
    const incompleteData = [{ id: '1', title: 'Test' }]; // Missing status
